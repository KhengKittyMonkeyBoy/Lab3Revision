...
def total_cost_shopping():
    total_cost = 0  # Initialize total_cost outside the loop
    for item in price_list:
        if item in quantity_list:
            item_cost = price_list[item] * quantity_list[item]
            total_cost += item_cost  # Add the cost of this item to the total cost
    
    # Print the total cost after the loop finishes
    print("The total cost of your shopping is:", total_cost)
